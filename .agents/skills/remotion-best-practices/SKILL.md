...
If the video will be embedded in a landing page to show a product's features, selling points, or benefits for its users, also load [LP Product Video](./lp-product-video/REFERENCE.md) before planning scenes.
It covers planning, storytelling, UI presentation, on-screen text, and embedding. It is unrelated to the Remotion SaaS skill, which is about building apps that generate videos.
