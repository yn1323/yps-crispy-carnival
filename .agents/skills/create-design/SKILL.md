---
name: create-design
description: Create mock screen designs as Storybook stories using this project's design system (Chakra UI v3 + `src/components/ui/` wrappers). Use when the user asks to create a design, mock, screen proposal, or redesign such as "デザイン作って", "モック作って", "make a mock", or "design this screen". Handles both new-screen proposals and existing-screen redesigns.
---

# Storybook Mock Design Generator
...
**Copy tone** (from `AGENTS.md` text guidelines):
...
- `AGENTS.md`, `README.md`, or other documentation files
