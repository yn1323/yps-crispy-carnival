...
- LP・機能ページなど登録前の人が読む公開ページでは、`references/mobile-landing.md`を読み、スマホで読む長さ、改行、CTAの配置を決める。
...
- 公開ページの文言は、`references/mobile-landing.md`の「確認の手順」で幅360pxの行数と孤立した末尾を確認する。
