...
- 必要ならStorybookやPlaywrightでスクリーンショット確認。
...
- 大きく不確実なUIは最初から作り込みすぎず**プレースホルダーパターン**で
...
| Storybookでモック・デザイン案を作る | `create-design` |
