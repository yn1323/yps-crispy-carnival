...
import { StaffDetail, StaffDetailLoading, StaffDetailNotFound } from "@/src/components/features/Shop/StaffDetail";
...
export const StaffDetailPage = ({ shopId, staffId }: Props) => {
  ...
  return <StaffDetail staff={staff} shop={shop} isOwner={isOwner} />;
};
