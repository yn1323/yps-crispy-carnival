    ...
    <Surface>
      ...
      >
        <Stack gap={3}>
          ...
          <DemoCompleteCta />
          {showCloseHelp && (
            <Box bg="gray.50" borderWidth="1px" borderColor="gray.200" borderRadius="md" px={4} py={3}>
...
const DemoCompleteCta = () => (
  <Box bg="gray.50" borderWidth="1px" borderColor="gray.200" borderRadius="md" px={4} py={4} mt={2}>
    <Stack gap={3}>
