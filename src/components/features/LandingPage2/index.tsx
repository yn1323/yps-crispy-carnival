...
const Nav = () => (
  ...
  >
    <Flex w="full" maxW="1024px" mx="auto" align="center" justify="space-between" gap={4}>
      <HStack gap={2.5} fontWeight="bold" fontSize="18px" letterSpacing="0.02em">
        <Flex boxSize="28px" borderRadius="full" bg="whiteAlpha.300" align="center" justify="center" overflow="hidden">
...
const Footer = () => (
  <Box as="footer" bg="teal.600" color="white" px={{ base: 5, lg: 6 }} pt={16} pb={10}>
    ...
    <Flex
      ...
      gap={2}
    >
      <Box as="span">© {new Date().getFullYear()} シフトリ</Box>
