...
export const faqEntries: FaqEntry[] = [
  ...
  },
  {
    ...
    answer: ["店舗で希望を集める方法に合わせて、次の3つから選びます。"],
    points: [
      "時間指定：スタッフが働ける開始時間と終了時間を入力します。",
      "日ごと：スタッフが出勤できる日だけを選びます。",
      "勤務区分：早番や遅番など、店舗が用意した区分から選びます。同じ日に複数の区分も選べます。",
    ],
  ...
  },
  {
    ...
    answer: [
      "ダッシュボードの「スタッフ一覧」で「スタッフを招待」を押します。店舗専用のQRコードや登録リンクから本人に申請してもらう方法、管理者が手入力する方法、同じグループの別店舗から追加する方法を選べます。",
      "本人からの申請は、管理者が承認してから正式なスタッフになります。",
    ],
    keywords: ["スタッフ追加", "スタッフ招待", "従業員追加", "QRコード", "登録リンク", "手入力"],
    audience: "manager",
  ...
  },
  {
    ...
    answer: [
      ...
      "保存していない変更がある状態で戻ると、「保存する」か「保存しない」を選べます。「保存しない」を選ぶと、最後の保存後に加えた変更は失われます。",
    ],
  ...
  },
  {
    ...
    answer: [
      "「グループ設定」の「ユーザー」で「管理者を招待」を押します。現在のスタッフを選ぶか、利用できるプランでは氏名とメールアドレスを入力して招待できます。",
      "招待された人が同じメールアドレスでログインし、7日以内に連携すると管理者になります。無料プランは管理者1名までのため、現在のスタッフとの交代として案内されます。連携が完了するまでは現在の管理者が操作できます。",
      "無料プランで交代が完了すると、以前の管理者の管理権限は終了します。スタッフとしての所属、シフト対象、通知の設定は残ります。",
      "管理者を追加する未承認の招待は、期限内は管理者枠を使います。追加できない場合は不要な招待を取り消してください。無料プランの管理者交代招待は、追加枠を使いません。",
      "招待を開けない場合は、招待先と同じメールアドレスでログインし、期限切れまたは取消済みなら新しいリンクを依頼します。",
    ],
    keywords: [
      "管理者追加",
      "管理者交代",
  ...
  },
  {
    ...
    answer: [
      ...
      "画面に「新しい閲覧リンクを受け取る」が表示されている場合は、登録したメールアドレスを入力してください。入力内容が登録情報と一致し、再発行できる状態なら新しい案内を送ります。",
