...
export const faqEntries: FaqEntry[] = [
  ...
  },
  {
    ...
    answer: [
      ...
      "招待された人が同じメールアドレスでログインし、7日以内に招待を受け入れると管理者になります。管理者を追加する招待は、承認前でも期限内は管理者枠を使います。追加できない場合は、不要な招待を取り消してください。",
    ],
    keywords: ["管理者追加", "管理者招待", "店長", "シフト担当者", "権限", "7日", "管理者枠"],
    audience: "manager",
  },
  {
    id: "replace-manager",
    category: "organization-billing",
    question: "無料プランで管理者を交代するには？",
    answer: [
      "無料プランで管理者を招待すると、現在の管理者との交代として案内されます。招待された人が招待を受け入れるまでは、現在の管理者が操作できます。",
      "交代が完了すると、以前の管理者の管理権限は終了します。スタッフとしての所属、シフト対象、通知の設定は残ります。交代の招待は、追加の管理者枠を使いません。",
    ],
    keywords: ["管理者交代", "店長交代", "引き継ぎ", "権限移譲", "無料プラン", "交代招待"],
    audience: "manager",
  },
  {
    ...
    answer: [
      "招待先と同じメールアドレスでログインしてください。管理者招待の有効期限は7日です。",
      "期限切れまたは取消済みの場合は、現在の管理者に新しい招待を依頼してください。",
    ],
    keywords: ["管理者招待", "招待を開けない", "承認できない", "メールアドレス", "7日", "期限切れ", "取消済み"],
    audience: "manager",
  },
  {
    id: "usage-count",
