...
const billing: OrganizationBillingView = {
  ...
  shopUsage: { current: 3, max: 5, pendingInvitations: 0 },
...
export const Trial: Story = {
  ...
  args: {
    billing: {
      ...
      currentPlan: "trial",
      hasStripeCustomer: false,
      peopleUsage: { current: 12, max: 50, pendingInvitations: 0 },
...
export const Pro: Story = {
  ...
  args: {
    billing: {
      ...
      state: "pro",
      currentPlan: "pro",
      peopleUsage: { current: 32, max: 50, pendingInvitations: 0 },
    },
  },
};
...
export const ScheduledProToStandard: Story = {
  ...
  args: {
    billing: {
      ...
      peopleUsage: { current: 21, max: 25, pendingInvitations: 0 },
