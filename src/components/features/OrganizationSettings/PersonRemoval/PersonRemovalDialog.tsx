  ...
  switch (dialog.kind) {
    case "removePersonFromShop":
      return {
        title: "操作中の店舗から削除",
        messages: [
          "この店舗のスタッフ所属だけを終了します。事業者の人物情報、ほかの店舗所属、管理者権限は変更しません。",
          "最後の店舗所属を外した後も、事業者に残るため利用人数には引き続き含まれます。",
          "将来のシフトに割り当てられている場合は削除できません。先に割当を解除または変更してください。",
        ],
        submitLabel: "店舗から削除",
        destructive: false,
      };
    case "removeManagerRole":
      return {
        ...
        messages: dialog.person.isStaff
          ? [
              "事業者全体の管理権限と契約操作の権限を終了します。スタッフとしての店舗所属と業務用アクセスは維持します。",
              "この人物が発行した未承認の管理者招待は無効になります。",
            ]
          : [
              "この人物にはスタッフ所属がないため、管理者権限を外すと、この事業者へのアクセスも終了します。過去の履歴は保持します。",
    ...
    case "removePerson":
      return {
        title: "事業者から利用者を削除",
        messages: [
          "この事業者のすべての店舗所属、管理権限、スタッフ権限、閲覧権限を終了します。ほかの事業者への所属には影響しません。",
