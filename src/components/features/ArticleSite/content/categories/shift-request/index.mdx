...
slug: "shift-request"
title: "シフト希望を集める"
description: "提出依頼の文面、回収ルール、勤務パターンごとの聞き方、未提出の確認まで、希望をもれなく集めるコツを整理します。"
breadcrumbLabel: "シフト希望を集める"
pointTitle: "このカテゴリのポイント"
pointDescription: "LINE・紙・Excelのどれで集めるにしても、依頼文・締切・記入形式・勤務パターンの名前を先にそろえておくと、あとからの聞き直しや転記の手間を減らせます。"
...
ctaDescription: "シフトリなら、提出状況の確認も未提出者へのリマインドも、まとめてかんたんに行えます。"
---
