...
| [スタッフ参加QR・承認導線](features/staff-registration.md) | 店舗専用QR/URLからスタッフ本人が参加申請し、店長が承認する導線 | 実装済 |
| [ログイン後オンボーディング](features/dashboard-onboarding.md) | 店舗登録後に店長自身で募集作成・通知確認・提出確認を試すDashboard内Callout | 実装済 |
| [シフト募集管理](features/shift-recruitment-management.md) | 店長がシフト募集を作成・確認・削除する管理導線 | 実装済 |
