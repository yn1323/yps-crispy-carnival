...
管理ユーザー・スタッフ向けプライバシーポリシーは、管理ユーザー等による削除を除き、シフト募集、提出された希望シフト、確定シフトとこれらに関する通知履歴を対象期間の終了日から少なくとも6か月間保持することを明記する。管理ユーザー向けプライバシーポリシーでは、この期間が管理ユーザー自身の法定保存義務を代替しないことも案内する。6か月後の自動削除や自動非表示は実装せず、本文変更に合わせて文書版と同意要求版を更新する。
