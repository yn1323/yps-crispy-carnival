...
- グループから削除済みの人物が同じメールアドレスで再申請した場合は、シフト担当者の承認を再追加の確認として、同じ人物をactiveへ戻して新しいstaff IDを作る。旧staff、管理者所属、session、magic link、LINE tokenは復元せず、アカウント削除受付済みの人物は承認しない。
