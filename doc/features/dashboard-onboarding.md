...
- `src/components/features/Dashboard/HeroSummary/` — オンボーディング中に通常の「今やること」セクションを隠す表示制御
- `src/components/features/Dashboard/DashboardOnboarding/` — オンボーディング状態、Callout UI、進捗判定、通常の「今やること」との表示切り替え、モーダル/画面遷移との接続、Storybook、ロジックテストを所有する
