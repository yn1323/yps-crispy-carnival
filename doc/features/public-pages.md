...
追加組織作成機能が明示的に有効な場合の二つ目以降の組織に対する無料体験と、有料プランの条件は、将来機能の内部契約として保持する。
...
追加組織の2暦月無料体験は、追加組織作成機能を提供している場合の条件として表示し、初回登録の条件とは分ける。

有料プランの申込機能が未公開であることも表示する。

将来の販売条件として、役務提供事業者、運営責任者、所在地、電話番号、問い合わせ先、Pro・Businessそれぞれの販売価格、支払方法と時期、提供時期、契約期間、自動更新、追加組織の無料体験、利用停止、返金、利用上限、動作環境を表示する。
