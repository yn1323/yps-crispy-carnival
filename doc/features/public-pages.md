...
`PricingSite`が表示する初回組織、追加組織のFree、Pro、Businessの利用人数、店舗数、管理ユーザー数は、backend enforcementと同じbrowser-safeな`ORGANIZATION_PLAN_LIMITS`を参照する。
...
初回組織では、Businessと同じ利用人数40名、稼働店舗5件、有効管理ユーザー5名まで利用できる。
