...
| 計画 | 状態 | 未完了条件 | 現在の正本 |
|---|---|---|---|
| [VRT・E2EレポートのR2移行](2026-09-05_VRT_E2Eレポート_R2移行_実装計画.md) | `implementing` | 1公開bucket・キー1組・r2.devで実装し、PR #900で確認中。R2実認証・公開URL・削除権限の接続確認は成功。baseline初期移行、最新headのCI・自動レビュー、公開・保持の確認が未完了 | [CI/CD運用](../manual/ci-cd.md)、[実環境の証跡](../manual/release-status.md) |
