...
| 計画 | 状態 | 未完了条件 | 現在の正本 |
|---|---|---|---|
| [VRT・E2EレポートのR2移行](2026-09-05_VRT_E2Eレポート_R2移行_実装計画.md) | `implementing` | 1公開bucket・キー1組・r2.devで実装中。repository設定の存在は確認済み。R2実認証、baseline初期移行、最新headのCI・自動レビュー、PR終了時削除・Artifact保持の実検証が未完了 | [CI/CD運用](../manual/ci-cd.md) |
