...
| 計画 | 分類根拠 | 現在の正本 |
|---|---|---|
| [teal低階調token明示利用廃止](2026-08-06_teal低階調token明示利用廃止_実装計画.md) | 明示指定123件を0件化し、Agent指示、UI規約、Skill参照、静的・通常検証を完了。VRTは利用者確認へ引き渡し | [UI設計方針](../rules/ui-design.md)、[ルートAgent指示](../../AGENTS.md) |
