...
| 計画 | 状態 | 次に必要な判断 | 現在の正本 |
|---|---|---|---|
| [分析KPIと内部BI再設計](2026-08-02_分析KPIと内部BI再設計_実装計画.md) | `reviewing` | KPI定義、health閾値、retentionを確定する | 現行実装は[分析KPI蓄積基盤](../features/analytics.md)と[分析KPI可視化アプリ](../features/analytics-dashboard.md) |
