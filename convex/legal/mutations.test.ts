...
import { getTestOrganizationId,
seedCanonicalStaffLineRecipient, seedManagerShop, seedShop } from "../_test/seed";
...
describe("legal/mutations", () => {
  ...
  it("管理ユーザーの再同意を記録する", async () => {
    ...
    const result = await t
      ...
      .mutation(api.legal.mutations.acceptManagerLegalConsent, { acceptedLegal: true, expectedOrganizationId: await getTestOrganizationId(t, shopId),
      shopId });
