...
const app = defineApp({
  env: {
    ...
    FEATURE_ORGANIZATION_CREATION: v.optional(v.string()),
    FEATURE_SHOP_ADDITION: v.optional(v.string()),
    FEATURE_MANAGER_INVITATION: v.optional(v.string()),
    FEATURE_BILLING: v.optional(v.string()),
