...
type BillingView = {
  state: BillingPlan | "initialPaymentPending" | "pendingActivation" | "grace" | "scheduledChange" | "migrationPending";
    ...
    switch (state.kind) {
      case "trial":
        billing = {
          ...
          // trialEndsAt は登録開始日の3か月後の同日（同日がなければ月末）の0:00 JSTを表す排他的な境界。
