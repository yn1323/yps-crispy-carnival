...
// 退職済みユーザーを閲覧できるか
export const canViewResignedUsers = (role: ShopUserRoleType | null) =>
  role === "owner" || role === "manager";

// 店舗の管理情報（メモ、時給など）を閲覧できるか
export const canViewShopUserInfo = (role: ShopUserRoleType | null) =>
  role === "owner" || role === "manager";

// 他ユーザーの所属店舗一覧を閲覧できるか
export const canViewOtherUserShops = (role: ShopUserRoleType | null) =>
  role === "owner" || role === "manager";

// === 操作権限 ===

// 店舗情報を更新できるか
export const canUpdateShop = (role: ShopUserRoleType | null) =>
  role === "owner" || role === "manager";

// 店舗を削除できるか
export const canDeleteShop = (role: ShopUserRoleType | null) =>
  role === "owner";

// ユーザーを店舗に追加できるか
export const canAddUser = (role: ShopUserRoleType | null) =>
  role === "owner" || role === "manager";
...
export const canUpdateShopUserInfo = (role: ShopUserRoleType | null) =>
  role === "owner" || role === "manager";
